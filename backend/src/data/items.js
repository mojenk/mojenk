...
const CATALOG = [
  ...
  { id: 'dagger',         name: 'Hançer',              type: 'weapon', price: 30,  sellPrice: 15,  description: '1d4 hızlı kesici hasar',              category: 'Silah', rarity: RARITY.COMMON, scenarios: [...MEDIEVAL_FANTASY, 'realistic'], image: '/items/dagger.png' },
  { id: 'sling',          name: 'Sapan',               type: 'weapon', price: 20,  sellPrice: 10,  description: 'Menzilli silah, 1d4 künt hasar',      category: 'Silah', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY, image: '/items/sling.png' },
  { id: 'sword_iron',     name: 'Demir Kılıç',         type: 'weapon', price: 80,  sellPrice: 40,  description: '1d8 kesici hasar',                    category: 'Silah', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY, image: '/items/sword_iron.png' },
  ...
  { id: 'spear',          name: 'Mızrak',              type: 'weapon', price: 55,  sellPrice: 27,  description: '1d8 delici hasar, uzun menzil avantajı', category: 'Silah', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY, image: '/items/spear.png' },
