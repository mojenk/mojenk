...
const CATALOG = [
  ...
  { id: 'potion_small',   name: 'Küçük Can İksiri',   type: 'potion', price: 30,  sellPrice: 15,  description: '2d6+8 HP yeniler',                    category: 'Tüketici', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY },
  ...
  { id: 'antidote',       name: 'Panzehir',            type: 'misc',   price: 30,  sellPrice: 15,  description: 'Zehiri iyileştirir',                  category: 'Tüketici', rarity: RARITY.COMMON, scenarios: [...MEDIEVAL_FANTASY, 'realistic', 'horror'] },
  { id: 'dagger',         name: 'Hançer',              type: 'weapon', price: 30,  sellPrice: 15,  description: '1d4 hızlı kesici hasar',              category: 'Silah', rarity: RARITY.COMMON, scenarios: [...MEDIEVAL_FANTASY, 'realistic'] },
  ...
  { id: 'sword_iron',     name: 'Demir Kılıç',         type: 'weapon', price: 80,  sellPrice: 40,  description: '1d8 kesici hasar',                    category: 'Silah', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY },
  { id: 'cloak_fur',      name: 'Kürk Pelerin',        type: 'armor',  price: 25,  sellPrice: 12,  description: '+1 AC, soğuğa karşı korur',           category: 'Zırh', rarity: RARITY.COMMON, scenarios: [...MEDIEVAL_FANTASY, 'mountain', 'realistic'] },
  { id: 'shield',         name: 'Kalkan',              type: 'armor',  price: 50,  sellPrice: 25,  description: '+1 AC, sol el',                       category: 'Zırh', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY },
  { id: 'armor_leather',  name: 'Deri Zırh',           type: 'armor',  price: 70,  sellPrice: 35,  description: '+2 AC',                               category: 'Zırh', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY },
  ...
  { id: 'lantern',        name: 'Fener',               type: 'misc',   price: 25,  sellPrice: 12,  description: 'Geniş bir alanı aydınlatır',          category: 'Çeşitli', rarity: RARITY.COMMON, scenarios: ['all'] },
  ...
  { id: 'spear',          name: 'Mızrak',              type: 'weapon', price: 55,  sellPrice: 27,  description: '1d8 delici hasar, uzun menzil avantajı', category: 'Silah', rarity: RARITY.UNCOMMON, scenarios: MEDIEVAL_FANTASY },
  { id: 'bow',            name: 'Uzun Yay',            type: 'weapon', price: 90,  sellPrice: 45,  description: 'Menzilli silah, 1d8 delici hasar',    category: 'Silah', rarity: RARITY.UNCOMMON, scenarios: MEDIEVAL_FANTASY },
  ...
  { id: 'staff',          name: 'Büyücü Asası',        type: 'weapon', price: 105, sellPrice: 53,  description: '1d6 arkane hasar, büyüyü güçlendirir', category: 'Silah', rarity: RARITY.RARE, scenarios: MEDIEVAL_FANTASY },
  { id: 'crossbow',       name: 'Arbalet',             type: 'weapon', price: 115, sellPrice: 58,  description: 'Menzilli silah, 1d10 delici hasar',   category: 'Silah', rarity: RARITY.RARE, scenarios: MEDIEVAL_FANTASY },
  ...
  { id: 'sword_short',    name: 'Kısa Kılıç',         type: 'weapon', price: 45,  sellPrice: 22,  description: '1d6 hızlı kesici hasar, dar alanlarda ideal', category: 'Silah', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY, image: '/items/sword_short.png' },
  { id: 'sword_long',     name: 'Uzun Kılıç',         type: 'weapon', price: 70,  sellPrice: 35,  description: '1d8+1 delici hasar, uzun menzil avantajı', category: 'Silah', rarity: RARITY.COMMON, scenarios: MEDIEVAL_FANTASY, image: '/items/sword_long.png' },
  ...
  { id: 'shield_steel',   name: 'Çelik Kalkan',        type: 'armor',  price: 90,  sellPrice: 45,  description: '+2 AC, sol el',                       category: 'Zırh', rarity: RARITY.UNCOMMON, scenarios: MEDIEVAL_FANTASY },
