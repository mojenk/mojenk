...
import { getAuth, GoogleAuthProvider, signInWithPopup, signInWithRedirect, getRedirectResult, signInAnonymously, signInWithEmailAndPassword, createUserWithEmailAndPassword, onAuthStateChanged, signOut, signInWithCredential } from 'firebase/auth';
...
export { auth, googleProvider, messaging, getToken, onMessage, signInWithPopup, signInWithRedirect, getRedirectResult, signInAnonymously, signInWithEmailAndPassword, createUserWithEmailAndPassword, onAuthStateChanged, signOut, signInWithCredential, GoogleAuthProvider, firebaseInitError };
export default app;
